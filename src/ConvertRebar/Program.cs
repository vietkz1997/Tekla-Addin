...
namespace BimCommands.ConvertRebar
{
    internal static class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            {
                File.WriteAllText("convert_rebar_error.log", ex.ToString());
                MessageBox.Show("Lỗi khởi chạy Convert-rebar: " + ex.Message, "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private static Assembly CurrentDomain_AssemblyResolve(object sender, ResolveEventArgs args)
        {
            try
            {
                ...
                // 1. Check current directory (release/ or dist/)
